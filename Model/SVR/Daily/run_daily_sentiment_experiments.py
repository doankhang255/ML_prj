...
SCRIPT_PATH = Path(__file__).resolve().parent / "svr_daily_sentiment_pipeline.py"
DEFAULT_OUTPUT_ROOT = Path(__file__).resolve().parent / "daily_sentiment_outputs" / "experiments"
...
def run_one(
    ...
    command = [
        ...
        str(output_dir),
        "--plot-path",
        "daily_svr_return_prediction.png",
    ]
    ...
    summary_path = output_dir / "daily_svr_vnindex_summary.json"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run multiple daily sentiment SVR tuning experiments and summarize results."
    )
    parser.add_argument("--targets", default="future_ret_1d,future_ret_5d,future_ret_10d,future_ret_20d")
...
def main() -> None:
    ...
    summary_path = args.output_root / "daily_experiment_summary.csv"
